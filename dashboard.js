...
document.addEventListener("DOMContentLoaded", () => {
  ctx1 = document.getElementById("graficoProduccion")?.getContext("2d");
  ctx2 = document.getElementById("graficoBeneficio")?.getContext("2d");

  if (!ctx1 || !ctx2 || !resumenCampos) return;
